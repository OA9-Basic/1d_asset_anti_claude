          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-muted-foreground max-w-md mb-4">
                Group-buying marketplace for digital assets. Fund together, access together. Join
                thousands of users pooling resources to purchase expensive courses, software, and
                digital products.
              </p>
