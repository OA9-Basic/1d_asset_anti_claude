...
export const metadata: Metadata = {
  ...
  description: 'Join forces with others to purchase expensive courses, software, and digital products. Contribute any amount - when the asset is funded, everyone gets access!',
